...
namespace AssemblyCSharp {
  public class APIS {
    ...
    public const string UPDATE_INFO_JSON_URL = "http://njmj-1252425265.cossh.myqcloud.com/version.json"; //服务器上最新的软件版本信息存储文件
    ...
    //public const string SocketUrl = "ipai.soyo.io";
    ...
    public const int UPDATE_GLOBAL_DATA_RESPONSE = 0x000108;//更新全局数据
    public const int UPDATE_ROOMCARD_REQUEST = 0x000109;//更新房卡信息
    ...
    public const int BUHUA_RESPONSE = 0x100021;// Buhua
    public const int BUHUA_REQUEST = 0x100022;// Buhua
    public const int HUAGANG_RESPONSE = 0x100023;// Buhua
    public const int SCORE_RESPONSE = 0x100024;// Score
    public const int BUHUA_BEGIN_RESPONSE = 0x100025;// Score
    ...
    public const int TIME_WAIT_RESPONSE = 0x009999; // time wait
